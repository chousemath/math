...
export const areaCircle = M.areaCircle;
export const areaParallelogram = M.areaParallelogram;
export const areaRectangle = M.areaRectangle;
export const areaSquare = M.areaSquare;
